...
#!/usr/bin/python
# coding=utf-8
# coded by :efk enjiola 
# https://www.facebook.com/itz.efk.3
...
\033[1;97m            @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m           @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m          @@@••••••••••EFK•••••••@@@ \033[1;0m
\033[1;97m         @@@••••••••••ENIOLA•••••@@@ \033[1;0m
\033[1;97m        @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m       @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m      @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : ENIOLAHACKING
\033[1;93m➤\033[1;97m Github   :https://github.com/Eniolahacking/mm.git
\033[1;93m➤\033[1;97m Fb Id  : https://www.facebook.com/itz.efk.3
\033[1;97m--------------------------------------------------
"""
...
def tech_abm():
    ...
    if username =="efk":
        os.system("clear")
        print logo
        print ("[+] Username : efk (Correct)")
        passwordss = raw_input("\033[1;97m[+]\033[1;97m Password :\033[1;97m ")
        if passwordss =="eniola":
            os.system("clear")
            print logo
            logging()
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : efk\033[1;92m (Correct)")
            print ("\033[1;97m[+]\033[1;92m Password : eniola\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
	    ...
	    os.system('xdg-open https://m.facebook.com/itz.efk.3')
            time.sleep(1)
            tech_abm()
    else:
...
def crack():
	...
	os.system("python3 .loading.md")
        os.system('clear')
        print logo
	print ("\033[1;97m[1]\033[1;91m-⋄-\033[1;97mCrack From Friend List @efk")
